...
let stringToUse = buttonEl.innerHTML
test.append(buttonEl);


const reverseInnerHTMLHandler = (event) => {
 let resultString = stringToUse.split('').reverse().join('');

    buttonEl.innerHTML = resultString;
    stringToUse = resultString;
};
